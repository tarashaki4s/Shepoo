    ...
    <nav class="navbar navbar-light bg-light navbar-expand-lg " id="shopeeNavCenter">
        <div class="container">
            <div class="col-sm-3">
                ...
                <span style="font-size: 25px; font-weight: 400;">Đăng Nhập</span>
            </div>
                        ...
                        <div class="container ">
                            ...
                            <div class="input-place">
                                <div class="inputGroup">
                                    <input placeholder="Email/Số Điện Thoại/Tên Đăng Nhập" name="txtUserName" ng-model="userName" type="text"  class="form-control" aria-describedby="passwordHelpBlock" required>
                                    <div class="form-text error">
                                        <span id="chkUserName" ng-show="frmLogin.txtUserName.$invalid">Vui lòng nhập tài khoản</span>
                                    </div>
                                </div>
                                <div class="inputGroup">
                                    <input placeholder="Mật Khẩu" name="txtPassword" type="password" ng-model="password"  class="form-control" aria-describedby="passwordHelpBlock" required>
                                    <div  class="form-text error">
                                        <span ng-show="frmLogin.txtPassword.$invalid">Vui lòng nhập mật khẩu</span>
                                    </div>
                                </div>
                                <br>
                                <button class="btn-lg btn-block col-sm-12 sign-in" ng-click="login()">Đăng Nhập</button>
                                <small id="loginFm" style="color: #f94e30; display: none;">Sai tài khoản hoặc mật khẩu</small>
                                <div class="forgot-password justify-content-around">
                                    <a data-bs-toggle="modal" data-bs-target="#exampleModal">Quên Mật Khẩu</a>
                                    <a style="margin-left: 125px;">Đăng Nhập bằng SMS</a>
                                    <br>
                                    <div class="separator">Hoặc</div>
                                </div>
                                <br>
                                <div class="button-link d-flex justify-content-center">
                                    <button type="button" class="btn btn-outline-secondary"><i class="fab fa-facebook-f" style="color: blue;"></i> Facebook</button>
                                    <button type="button" class="btn btn-outline-secondary"><i class="fab fa-google" style="color: red;"></i> Google</button>
                                    <button type="button" class="btn btn-outline-secondary" style="width: 100px;"><i class="fab fa-apple" style="color: black;"></i>Apple</button>
                                </div>
